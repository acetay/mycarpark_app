...
function PassengerLanding() {
  ...
  const routeToDriver = () => {
    window.location.replace(
      `https://www.google.com/maps/dir/?api=1&origin=${origin}+singapore&destination=${userlocale}+singapore&travelmode=walking`
    );
    setOrigin('');
  };
      ...
      {loading ? (
        ...
        <>
          ...
          <h1 className="font-bold text-2xl text-blue-400">
            {username} has sent you a route to reach his location
          </h1>
